      ...
      <div className="container text-center">
        <div className="row mt-4">
          <div className="col bg-dark">
            <h5 className="fw-bold p-4 putih">Konversi Desimal</h5>
            <div className="mb-3 row">
              <label name="pilihan" value="10" className="col-sm-2 col-form-label putih text-start">Desimal</label>
            ...
            <div className="mb-3 row form-group">
              ...
              <select className="form-select form-control form-select-md" aria-label=".form-select-sm example" onChange={this.konversi}>
                ...
                <option name="konversi" value="10" disabled>Desimal</option>
              </select>
              </div>
            </div>
